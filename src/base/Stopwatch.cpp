...
{
    if (!triggered) {
        m_mark = cisp::current_time_seconds();
    }
}
...
Stopwatch::reset()
{
    if (m_stopped) {
        ...
        const double t = cisp::current_time_seconds();
...
Stopwatch::stop()
{
    ...
    m_mark = cisp::current_time_seconds() - m_mark;
    m_stopped = true;
}
...
Stopwatch::getTime()
{
    if (m_triggered) {
        ...
        return cisp::current_time_seconds() - m_mark;
    }
}
